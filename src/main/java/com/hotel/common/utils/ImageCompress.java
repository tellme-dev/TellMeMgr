...
public class ImageCompress {
    ...
    public static void imageCompress(String path, String fileName,
            String toFileName, float scale, float quality) {//String toFileName, float scale, float quality, int width, int height)
...
//    	mypic.imageCompress("D:\\Utron\\智慧酒店\\images\\hotel\\item\\h28\\", "28_1451037983363.png", "yasuo.png", 1.0f, 0.75f);
//    }
